...
enum {
	...
	/* The minimum version that
	 * the iwpm kernel supports.
	 */
...
enum {
	IWPM_NLA_RADD_UNSPEC = 0,
	IWPM_NLA_RADD_SEQ,
	IWPM_NLA_RADD_ADDR,
	IWPM_NLA_RADD_MAPPED_LOC_ADDR,
	IWPM_NLA_RADD_ERR,
	IWPM_NLA_RADD_MAX
};

enum {
	IWPM_NLA_REMOVE_UNSPEC = 0,
	IWPM_NLA_REMOVE_SEQ,
	IWPM_NLA_REMOVE_ADDR,
	IWPM_NLA_REMOVE_MAX,
};
