...
enum {
	IWPM_NLA_ADD_MAPPING_UNSPEC = 0,
	IWPM_NLA_ADD_MAPPING_SEQ,
	IWPM_NLA_ADD_MAPPING_ADDR,
	IWPM_NLA_ADD_MAPPING_FLAGS,
	IWPM_NLA_ADD_MAPPING_MAX,
};

enum {
	IWPM_NLA_RADD_MAPPING_UNSPEC = 0,
	IWPM_NLA_RADD_MAPPING_SEQ,
	IWPM_NLA_RADD_MAPPING_ADDR,
	IWPM_NLA_RADD_MAPPING_MAPPED_LOC_ADDR,
	IWPM_NLA_RADD_MAPPING_ERR,
	IWPM_NLA_RADD_MAPPING_MAX
};

enum {
	IWPM_NLA_REMOVE_MAPPING_UNSPEC = 0,
